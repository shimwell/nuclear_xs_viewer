      ...
      <Container className="App">
        <Row>
          <Col>
            ...
            <p>
              Search 101,294 cross sections processed with
            ...
            <p>
              ...
              Site
              <a href="https://github.com/Shimwell/nuclear_xs_compose/blob/master/LICENSE">
                license
              </a>
            </p>
          </Col>
        ...
        <Row>
          ...
          <Col md="7" lg="7">
            ...
            <ScaleSlider
              onChange={event =>
                this.handle_axis_change("x_axis_mutliplier", event)
              }
              plotted_data={this.state.plotted_data}
              x_axis_label={this.state.x_axis_label}
              y_axis_label={this.state.y_axis_label}
